...
public class ProductService implements IProductService {
    public final static String DATA_PRODUCT_PATH = "Product-Manager/data/products.csv";
    public final static String DATA_PRODUCT_DELETED_PATH = "Product-Manager/data/data_deleted/product_deleted.csv";
